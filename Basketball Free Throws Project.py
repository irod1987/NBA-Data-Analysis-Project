...
#Created this matrix using the np.array method. 
...
#Visualizing Free throw attemps by player index [0] == Kobe Bryant
plt.plot(Free_Throws_Attempts[0], c = 'Blue', ls = '--', marker = 's', ms = 7)
plt.xticks(list(range(0, 10)), Seasons, rotation = 'vertical')#number and names of tick in x.
plt.show()
...
#Creating visualization using function myplot, which takes a data set given (salaries, games, etc)
#we created 2 dictionaries col and marker to be used in the loop. With our for loop, we assign the data
#as it is in the Pdict. 
#list of players assigning values (col, ls,marker,ms. )
...
#Once our function is working we can do Math using it. 
#Free throws per game
myplot (Free_Throws/Games)
...
myplot (Free_Throws/Free_Throws_Attempts)


# In[44]:


#Player_Playing_Style =  (np.matrix.round((Points - Free_Throws)/ FieldGoals,2))
